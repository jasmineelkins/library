        ...
        <div className="modal-background-mask" />
            <div className="modal">
                <div className="modalContent scroll">
                    <div className="closeDiv"><AiFillCloseCircle onClick={closeModal} className="closeCircleSize"/></div>
                        { clickedBook.volumeInfo.imageLinks === undefined ? <span>undefined image links</span>
                        :<div className="bookModalImgContainer"><img src={clickedBook.volumeInfo.imageLinks.thumbnail} alt={title} className="bookImgModal"/>
